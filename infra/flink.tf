...
resource "aws_kinesisanalyticsv2_application" "silver" {
  ...
  # 앱 : true면 즉시 실행, false면 생성만 하고 실행은 직접 세팅
    ...
    environment_properties {
      ...
      property_group {
        ...
        property_map = {
          ...
          # python UDF Worker가 transform.py를 import하도록 등록
